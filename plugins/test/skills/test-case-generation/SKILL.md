...
- 输出产物：`final_cases.json`（必须）、`test_cases.json`（review 前中间版本）、`review_result.md`、`review_summary.json`、`decomposition.md`、`context_summary.md`（仅 >= 3 模块时生成）
...
| 5. review | 自审 + 冗余对评审，4 维度质量检查 | `test_cases.json`、`review_result.md` |
...
| `review_result.md` | review | 4 维度冗余对评审结果 |
