...
提供子命令：
  ...
  import-cases       按 module 字段分组导入用例（自动创建子模块 + 打标签）
...
_DEFAULTS = {
    'MS_BASE_URL': 'https://metersphere.tapsvc.com',
    'MS_ACCESS_KEY': 'PydgQJ6DUjkFmmhd',
    'MS_SECRET_KEY': 'xzlNMqdEKAQ0HxNE',
    'MS_PROJECT_ID': 'be262c1d-279c-11ee-9cbe-ca9edfdde60a',
    'MS_WORKSPACE_ID': 'be25c7f8-279c-11ee-9cbe-ca9edfdde60a',
    'MS_DEFAULT_NODE_ID': 'bb68d3a9-1c36-4396-abb5-365e2a7ec0f4',
    'MS_PLAN_NODE_ID': 'b3a09e12-dae8-42eb-b91a-dedf7b3b2564',
}
...
def _add_case(module_id: str, case_data: dict, module_path: str = '') -> Any:
    ...
    payload = {
        ...
        'projectId': _cfg('MS_PROJECT_ID'),
        'addFields': [
            {'fieldId': '46065143-9d1d-11eb-b418-0242ac120002', 'value': f'"{maintainer}"'},
            {'fieldId': '4619cc23-9d1d-11eb-b418-0242ac120002', 'value': f'"{priority}"'},
            {'fieldId': '45f2de57-9d1d-11eb-b418-0242ac120002', 'value': '"Prepare"'},
            {'fieldId': 'e21771a5-de33-4b06-9f0b-08b08f412d34', 'value': '""'},
        ],
        'editFields': [],
        'requestFields': [
            {'id': '46065143-9d1d-11eb-b418-0242ac120002', 'name': '责任人', 'customData': None, 'type': 'member', 'value': maintainer},
            {'id': '4619cc23-9d1d-11eb-b418-0242ac120002', 'name': '用例等级', 'customData': None, 'type': 'select', 'value': priority},
            {'id': '45f2de57-9d1d-11eb-b418-0242ac120002', 'name': '用例状态', 'customData': None, 'type': 'select', 'value': 'Prepare'},
            {'id': 'e21771a5-de33-4b06-9f0b-08b08f412d34', 'name': '是否已自动化', 'customData': None, 'type': 'radio', 'value': ''},
        ],
        'fields': [],
        'follows': [],
    }
...
def _create_plan(name: str, stage: str = 'smoke') -> dict:
    """创建测试计划（归类到 AI 工作流节点）"""
...
def main():
    ...
    try:
        if cmd == 'ping':
            ...
            if len(args) < 2:
                print("用法: import-cases <parent_module_id> <cases.json>", file=sys.stderr)
                sys.exit(1)
            cmd_import_cases(args[0], args[1])
